...
public:
    ...
    const MacroOp macroOps[151] = {
        ...
        {"LDA_IMM",  {0xA9, -1, -1}, 2}, {"LDA_ZP",   {0xA5, -1, -1}, 2}, {"LDA_ZPX",  {0xB5, -1, -1}, 2}, {"LDA_ABS",  {0xAD, -1, -1}, 3},
        {"LDA_ABX",  {0xBD, -1, -1}, 3}, {"LDA_ABY",  {0xB9, -1, -1}, 3}, {"LDA_INDX", {0xA1, -1, -1}, 2}, {"LDA_INDY", {0xB1, -1, -1}, 2},
        // LDX - Load X Register
        {"LDX_IMM",  {0xA2, -1, -1}, 2}, {"LDX_ZP",   {0xA6, -1, -1}, 2}, {"LDX_ZPY",  {0xB6, -1, -1}, 2}, {"LDX_ABS",  {0xAE, -1, -1}, 3}, {"LDX_ABY",  {0xBE, -1, -1}, 3},
        // LDY - Load Y Register
        {"LDY_IMM",  {0xA0, -1, -1}, 2}, {"LDY_ZP",   {0xA4, -1, -1}, 2}, {"LDY_ZPX",  {0xB4, -1, -1}, 2}, {"LDY_ABS",  {0xAC, -1, -1}, 3}, {"LDY_ABX",  {0xBC, -1, -1}, 3},

        // STA - Store Accumulator
        {"STA_ZP",   {0x85, -1, -1}, 2}, {"STA_ZPX",  {0x95, -1, -1}, 2}, {"STA_ABS",  {0x8D, -1, -1}, 3}, {"STA_ABX",  {0x9D, -1, -1}, 3},
        {"STA_ABY",  {0x99, -1, -1}, 3}, {"STA_INDX", {0x81, -1, -1}, 2}, {"STA_INDY", {0x91, -1, -1}, 2},
        // STX - Store X Register
        {"STX_ZP",   {0x86, -1, -1}, 2}, {"STX_ZPY",  {0x96, -1, -1}, 2}, {"STX_ABS",  {0x8E, -1, -1}, 3},
        // STY - Store Y Register
        {"STY_ZP",   {0x84, -1, -1}, 2}, {"STY_ZPX",  {0x94, -1, -1}, 2}, {"STY_ABS",  {0x8C, -1, -1}, 3},

        // ==========================================
        // 2. REGISTER TRANSFERS (Implied Mode)
        // ==========================================
        {"TAX_IMP",  {0xAA, -1, -1}, 1}, {"TAY_IMP",  {0xA8, -1, -1}, 1}, {"TXA_IMP",  {0x8A, -1, -1}, 1},
        {"TYA_IMP",  {0x98, -1, -1}, 1}, {"TSX_IMP",  {0xBA, -1, -1}, 1}, {"TXS_IMP",  {0x9A, -1, -1}, 1},

        // ==========================================
        // 3. STACK OPERATIONS (Implied Mode)
        // ==========================================
        {"PHA_IMP",  {0x48, -1, -1}, 1}, {"PLA_IMP",  {0x68, -1, -1}, 1}, {"PHP_IMP",  {0x08, -1, -1}, 1}, {"PLP_IMP",  {0x28, -1, -1}, 1},

        // ==========================================
        // 4. MATH & ARITHMETIC
        // ==========================================
        // ADC - Add with Carry
        {"ADC_IMM",  {0x69, -1, -1}, 2}, {"ADC_ZP",   {0x65, -1, -1}, 2}, {"ADC_ZPX",  {0x75, -1, -1}, 2}, {"ADC_ABS",  {0x6D, -1, -1}, 3},
        {"ADC_ABX",  {0x7D, -1, -1}, 3}, {"ADC_ABY",  {0x79, -1, -1}, 3}, {"ADC_INDX", {0x61, -1, -1}, 2}, {"ADC_INDY", {0x71, -1, -1}, 2},
        // SBC - Subtract with Carry
        {"SBC_IMM",  {0xE9, -1, -1}, 2}, {"SBC_ZP",   {0xE5, -1, -1}, 2}, {"SBC_ZPX",  {0xF5, -1, -1}, 2}, {"SBC_ABS",  {0xED, -1, -1}, 3},
        {"SBC_ABX",  {0xFD, -1, -1}, 3}, {"SBC_ABY",  {0xF9, -1, -1}, 3}, {"SBC_INDX", {0xE1, -1, -1}, 2}, {"SBC_INDY", {0xF1, -1, -1}, 2},

        // INC / DEC - Increment / Decrement Memory
        {"INC_ZP",   {0xE6, -1, -1}, 2}, {"INC_ZPX",  {0xF6, -1, -1}, 2}, {"INC_ABS",  {0xEE, -1, -1}, 3}, {"INC_ABX",  {0xFE, -1, -1}, 3},
        {"DEC_ZP",   {0xC6, -1, -1}, 2}, {"DEC_ZPX",  {0xD6, -1, -1}, 2}, {"DEC_ABS",  {0xCE, -1, -1}, 3}, {"DEC_ABX",  {0xDE, -1, -1}, 3},

        // INX/INY/DEX/DEY - Increment / Decrement Registers (Implied)
        {"INX_IMP",  {0xE8, -1, -1}, 1}, {"INY_IMP",  {0xC8, -1, -1}, 1}, {"DEX_IMP",  {0xCA, -1, -1}, 1}, {"DEY_IMP",  {0x88, -1, -1}, 1},

        // ==========================================
        // 5. BITWISE LOGIC
        // ==========================================
        // AND - Logical AND
        {"AND_IMM",  {0x29, -1, -1}, 2}, {"AND_ZP",   {0x25, -1, -1}, 2}, {"AND_ZPX",  {0x35, -1, -1}, 2}, {"AND_ABS",  {0x2D, -1, -1}, 3},
        {"AND_ABX",  {0x3D, -1, -1}, 3}, {"AND_ABY",  {0x39, -1, -1}, 3}, {"AND_INDX", {0x21, -1, -1}, 2}, {"AND_INDY", {0x31, -1, -1}, 2},
        // ORA - Logical Inclusive OR
        {"ORA_IMM",  {0x09, -1, -1}, 2}, {"ORA_ZP",   {0x05, -1, -1}, 2}, {"ORA_ZPX",  {0x15, -1, -1}, 2}, {"ORA_ABS",  {0x0D, -1, -1}, 3},
        {"ORA_ABX",  {0x1D, -1, -1}, 3}, {"ORA_ABY",  {0x19, -1, -1}, 3}, {"ORA_INDX", {0x01, -1, -1}, 2}, {"ORA_INDY", {0x11, -1, -1}, 2},
        // EOR - Logical Exclusive OR
        {"EOR_IMM",  {0x49, -1, -1}, 2}, {"EOR_ZP",   {0x45, -1, -1}, 2}, {"EOR_ZPX",  {0x55, -1, -1}, 2}, {"EOR_ABS",  {0x4D, -1, -1}, 3},
        {"EOR_ABX",  {0x5D, -1, -1}, 3}, {"EOR_ABY",  {0x59, -1, -1}, 3}, {"EOR_INDX", {0x41, -1, -1}, 2}, {"EOR_INDY", {0x51, -1, -1}, 2},

        // BIT - Bit Test
        {"BIT_ZP",   {0x24, -1, -1}, 2}, {"BIT_ABS",  {0x2C, -1, -1}, 3},

        // ==========================================
        // 6. SHIFTS & ROTATES
        // ==========================================
        // ASL - Arithmetic Shift Left
        {"ASL_IMP",  {0x0A, -1, -1}, 1}, {"ASL_ZP",   {0x06, -1, -1}, 2}, {"ASL_ZPX",  {0x16, -1, -1}, 2}, {"ASL_ABS",  {0x0E, -1, -1}, 3}, {"ASL_ABX",  {0x1E, -1, -1}, 3},
        // LSR - Logical Shift Right
        {"LSR_IMP",  {0x4A, -1, -1}, 1}, {"LSR_ZP",   {0x46, -1, -1}, 2}, {"LSR_ZPX",  {0x56, -1, -1}, 2}, {"LSR_ABS",  {0x4E, -1, -1}, 3}, {"LSR_ABX",  {0x5E, -1, -1}, 3},
        // ROL - Rotate Left
        {"ROL_IMP",  {0x2A, -1, -1}, 1}, {"ROL_ZP",   {0x26, -1, -1}, 2}, {"ROL_ZPX",  {0x36, -1, -1}, 2}, {"ROL_ABS",  {0x2E, -1, -1}, 3}, {"ROL_ABX",  {0x3E, -1, -1}, 3},
        // ROR - Rotate Right
        {"ROR_IMP",  {0x6A, -1, -1}, 1}, {"ROR_ZP",   {0x66, -1, -1}, 2}, {"ROR_ZPX",  {0x76, -1, -1}, 2}, {"ROR_ABS",  {0x6E, -1, -1}, 3}, {"ROR_ABX",  {0x7E, -1, -1}, 3},

        // ==========================================
        // 7. COMPARISONS
        // ==========================================
        // CMP - Compare Accumulator
        {"CMP_IMM",  {0xC9, -1, -1}, 2}, {"CMP_ZP",   {0xC5, -1, -1}, 2}, {"CMP_ZPX",  {0xD5, -1, -1}, 2}, {"CMP_ABS",  {0xCD, -1, -1}, 3},
        {"CMP_ABX",  {0xDD, -1, -1}, 3}, {"CMP_ABY",  {0xD9, -1, -1}, 3}, {"CMP_INDX", {0xC1, -1, -1}, 2}, {"CMP_INDY", {0xD1, -1, -1}, 2},
        // CPX - Compare X Register
        {"CPX_IMM",  {0xE0, -1, -1}, 2}, {"CPX_ZP",   {0xE4, -1, -1}, 2}, {"CPX_ABS",  {0xEC, -1, -1}, 3},
        // CPY - Compare Y Register
        {"CPY_IMM",  {0xC0, -1, -1}, 2}, {"CPY_ZP",   {0xC4, -1, -1}, 2}, {"CPY_ABS",  {0xCC, -1, -1}, 3},

        // ==========================================
        // 8. CONTROL FLOW (Jumps & Branches)
        // ==========================================
        // Jumps and Returns
        {"JMP_ABS",  {0x4C, -1, -1}, 3}, {"JMP_IND",  {0x6C, -1, -1}, 3},
        {"JSR_ABS",  {0x20, -1, -1}, 3}, {"RTS_IMP",  {0x60, -1, -1}, 1}, {"RTI_IMP",  {0x40, -1, -1}, 1},

        // Branches (Relative Mode)
        {"BCC_REL",  {0x90, -1, -1}, 2}, {"BCS_REL",  {0xB0, -1, -1}, 2}, {"BNE_REL",  {0xD0, -1, -1}, 2}, {"BEQ_REL",  {0xF0, -1, -1}, 2},
        {"BPL_REL",  {0x10, -1, -1}, 2}, {"BMI_REL",  {0x30, -1, -1}, 2}, {"BVC_REL",  {0x50, -1, -1}, 2}, {"BVS_REL",  {0x70, -1, -1}, 2},

        // ==========================================
        // 9. FLAG TOGGLES (Implied Mode)
        // ==========================================
        {"CLC_IMP",  {0x18, -1, -1}, 1}, {"SEC_IMP",  {0x38, -1, -1}, 1}, {"CLI_IMP",  {0x58, -1, -1}, 1}, {"SEI_IMP",  {0x78, -1, -1}, 1},
        {"CLV_IMP",  {0xB8, -1, -1}, 1}, {"CLD_IMP",  {0xD8, -1, -1}, 1}, {"SED_IMP",  {0xF8, -1, -1}, 1},

        // ==========================================
        // 10. SYSTEM CONTROLS (Implied Mode)
        // ==========================================
        {"BRK_IMP",  {0x00, -1, -1}, 1}, {"NOP_IMP",  {0xEA, -1, -1}, 1}
    };
